...
adapters_name = "/home//Repository/AI_Coach/INTEL/neural-chat_outputs_V3/checkpoint-100"
...
def chatbot():
    def send_message():
        ...
        if user_input:
            ...
            text = f"""You are a personal assistant . Help users to learn  fundamentals and techniques. Recommend ideal  exercises to help users to improve their  skills.
                    ### Instruction:{user_input} ### Response:"""
            ...
            if "<<" in response_text:
                ...
                extracted_response = response_text.strip()
                label = "other"
            #extracted_response = response_text.split("<<")[0].strip()
